    ...
    <>
      ...
      <div className="relative z-10">
        {features.map(({ icon: Icon, badge, title, description, buttonText, href, gradient, bgPattern }, index) => (
          ...
          >
            {/* Floating Elements */}
            <div className="absolute top-10 left-10 w-20 h-20 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full opacity-20 blur-lg animate-float"></div>
            <div className="absolute bottom-10 right-10 w-32 h-32 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full opacity-20 blur-lg animate-float" style={{ animationDelay: '1s' }}></div>
              ...
              <div className={`grid lg:grid-cols-2 gap-16 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                ...
                <div className={`space-y-8 ${index % 2 === 1 ? 'lg:col-start-2' : ''} animate-slide-up`}>
                  ...
                  <div className="inline-flex items-center gap-3 glass px-6 py-3 rounded-full hover-lift group">
                    <div className={`w-8 h-8 bg-gradient-to-br ${gradient} rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform`}>
                      <Icon size={18} className="text-white" />
                    </div>
                    <span className="text-sm font-bold text-gradient-primary">{badge}</span>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={text} className="flex items-center gap-3 group">
                        <div className={`w-10 h-10 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform`}>
                ...
                <div className={`relative ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                  <div className="relative">
                    ...
                    <div className="glass-dark rounded-3xl p-8 hover-lift animate-float">
                      <div className={`w-24 h-24 bg-gradient-to-br ${gradient} rounded-2xl flex items-center justify-center mx-auto mb-6 animate-pulse-glow`}>
                      ...
                      <div className="text-center space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 pt-6">
                          ...
                          <div className="glass rounded-xl p-4">
                            <div className="text-2xl font-black text-gradient-accent">24/7</div>
                    ...
                    <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full opacity-30 blur-lg animate-float"></div>
                    <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full opacity-30 blur-lg animate-float" style={{ animationDelay: '2s' }}></div>
                  </div>
                </div>
              </div>
            </div>
