...
export const careerCategories: CategoryDefinition[] = [
  {
    ...
    skills: [
      ...
      {
        canonical: 'Jest',
        aliases: ['jest', 'testing library', 'react testing library', 'vitest'],
        importance: 'adjacent',
      },
      {
        canonical: 'Responsive Design',
        aliases: ['responsive', 'mobile first', 'adaptive design'],
        importance: 'adjacent',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      { canonical: 'Django', aliases: ['django'], importance: 'core' },
      {
        ...
        aliases: ['spring', 'springboot', 'spring boot', 'spring framework'],
        importance: 'core',
      },
      {
        canonical: 'REST APIs',
        aliases: ['rest', 'rest api', 'restful', 'api design'],
        importance: 'core',
      },
      ...
      { canonical: 'gRPC', aliases: ['grpc'], importance: 'supporting' },
      {
        ...
        aliases: ['authentication', 'auth', 'jwt', 'oauth'],
        importance: 'supporting',
      },
      {
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        aliases: ['computer vision', 'opencv', 'image processing'],
        importance: 'supporting',
      },
      {
        canonical: 'NLP',
      ...
      { canonical: 'Keras', aliases: ['keras'], importance: 'supporting' },
      {
        ...
        aliases: ['data science', 'datascience'],
        importance: 'supporting',
      },
      ...
      {
        canonical: 'MLOps',
        aliases: ['mlops', 'ml ops', 'model deployment'],
        importance: 'adjacent',
      },
      {
  ...
  },
  {
    ...
    skills: [
      ...
      {
        canonical: 'UI Design',
        aliases: ['ui design', 'user interface', 'interface design'],
        importance: 'core',
      },
      {
        canonical: 'UX Design',
        aliases: ['ux design', 'user experience', 'ux'],
        importance: 'core',
      },
      {
        canonical: 'Prototyping',
        aliases: ['prototyping', 'prototype', 'wireframing', 'wireframe'],
        importance: 'core',
      },
      {
        canonical: 'User Research',
        aliases: ['user research', 'usability testing', 'ux research'],
        importance: 'core',
      },
      {
        canonical: 'Adobe XD',
      ...
      { canonical: 'Sketch', aliases: ['sketch'], importance: 'supporting' },
      {
        ...
        aliases: ['design systems', 'component library', 'style guide'],
        importance: 'supporting',
      },
      {
        canonical: 'Interaction Design',
        aliases: ['interaction design', 'motion design', 'microinteractions'],
        importance: 'supporting',
      },
  ...
  },
  {
    ...
    skills: [
      ...
      {
        canonical: 'Branding',
        aliases: ['branding', 'brand design', 'brand identity', 'logo design'],
        importance: 'core',
      },
      {
      ...
      },
      {
        ...
        aliases: ['typography', 'fonts', 'type design'],
        importance: 'supporting',
      },
      {
        canonical: 'Color Theory',
        aliases: ['color theory', 'color psychology'],
        importance: 'supporting',
      },
      {
        canonical: 'Digital Illustration',
        aliases: ['illustration', 'digital art', 'vector art'],
        importance: 'supporting',
      },
      {
        canonical: 'Print Design',
        aliases: ['print design', 'publishing', 'layout design'],
        importance: 'supporting',
      },
      { canonical: 'Canva', aliases: ['canva'], importance: 'adjacent' },
      {
        canonical: 'CorelDRAW',
        aliases: ['coreldraw', 'corel draw'],
        importance: 'adjacent',
      },
      {
        canonical: 'Affinity Designer',
        aliases: ['affinity designer', 'affinity'],
        importance: 'adjacent',
      },
    ],
  },
  ...
  },
  {
    ...
    skills: [
      ...
      {
        canonical: 'Ansible',
        aliases: ['ansible', 'configuration management'],
        importance: 'supporting',
      },
      {
        canonical: 'Monitoring',
        aliases: ['prometheus', 'grafana', 'datadog', 'monitoring'],
        importance: 'adjacent',
      },
      {
        canonical: 'Git',
      ...
      {
        canonical: 'Nginx',
        aliases: ['nginx', 'apache', 'reverse proxy'],
        importance: 'adjacent',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        canonical: 'Mobile UI',
        aliases: ['mobile ui', 'mobile design', 'app design'],
        importance: 'supporting',
      },
      { canonical: 'Expo', aliases: ['expo'], importance: 'adjacent' },
      {
        canonical: 'Ionic',
        aliases: ['ionic', 'cordova'],
        importance: 'adjacent',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        aliases: ['network security', 'firewall'],
        importance: 'core',
      },
      {
        canonical: 'Security Auditing',
        aliases: [
          'security audit',
      ...
      {
        canonical: 'OWASP',
        aliases: ['owasp', 'web security', 'application security', 'appsec'],
        importance: 'core',
      },
      {
        canonical: 'Cryptography',
        aliases: ['cryptography', 'encryption', 'ssl/tls'],
        importance: 'supporting',
      },
      {
        canonical: 'SIEM',
      ...
      },
      {
        ...
        aliases: ['cloud security', 'aws security', 'azure security'],
        importance: 'adjacent',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        aliases: ['smart contracts', 'smartcontract', 'contract development'],
        importance: 'core',
      },
      {
        canonical: 'Web3.js',
        aliases: ['web3', 'web3.js', 'ethers.js', 'ethers'],
        importance: 'core',
      },
      {
        canonical: 'DeFi',
      ...
      {
        canonical: 'NFT',
        aliases: ['nft', 'nft development'],
        importance: 'supporting',
      },
      {
        canonical: 'Hyperledger',
        aliases: ['hyperledger', 'fabric', 'enterprise blockchain'],
        importance: 'supporting',
      },
      {
        canonical: 'Rust',
  ...
  },
  {
    ...
    skills: [
      ...
      { canonical: 'C++', aliases: ['c++', 'cpp'], importance: 'core' },
      {
        ...
        aliases: ['game design', 'level design', 'game mechanics'],
        importance: 'core',
      },
      {
        canonical: 'C# (Game)',
        aliases: ['unity scripting'],
        importance: 'supporting',
      },
      {
        canonical: 'Blender',
        aliases: ['blender', '3d modeling', '3d art'],
        importance: 'supporting',
      },
      { canonical: 'Godot', aliases: ['godot'], importance: 'supporting' },
      {
        canonical: 'Game Physics',
        aliases: ['game physics', 'collision detection'],
        importance: 'adjacent',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        canonical: 'Cypress',
        aliases: ['cypress', 'e2e testing', 'end to end testing'],
        importance: 'core',
      },
      {
      ...
      },
      {
        ...
        aliases: ['manual testing', 'test cases', 'test plans'],
        importance: 'supporting',
      },
      {
        canonical: 'JUnit',
        aliases: ['junit', 'testng'],
        importance: 'supporting',
      },
      {
        canonical: 'BDD/TDD',
        aliases: ['bdd', 'tdd', 'behavior driven', 'test driven'],
        importance: 'adjacent',
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        aliases: ['data warehouse', 'snowflake', 'redshift', 'bigquery'],
        importance: 'core',
      },
      {
        canonical: 'Hadoop',
        aliases: ['hadoop', 'hdfs', 'mapreduce'],
        importance: 'supporting',
      },
      {
        canonical: 'Airflow',
        aliases: ['airflow', 'apache airflow', 'workflow orchestration'],
        importance: 'supporting',
      },
      {
        canonical: 'dbt',
  ...
  },
  {
    ...
    skills: [
      {
        canonical: 'C',
        aliases: ['c language', 'embedded c'],
        importance: 'core',
      },
      {
        canonical: 'Microcontrollers',
        aliases: ['microcontroller', 'mcu', 'arduino', 'raspberry pi'],
        importance: 'core',
      },
      {
        canonical: 'RTOS',
        aliases: ['rtos', 'real time os', 'freertos'],
        importance: 'core',
      },
      {
        canonical: 'Embedded Linux',
      ...
      {
        canonical: 'FPGA',
        aliases: ['fpga', 'vhdl', 'verilog'],
        importance: 'supporting',
      },
      {
        canonical: 'ARM',
        aliases: ['arm', 'arm cortex', 'stm32'],
        importance: 'supporting',
      },
      {
        canonical: 'Embedded C++',
        aliases: ['embedded cpp'],
        importance: 'adjacent',
      },
    ],
  },
...
export const combinationRoles: CombinationRole[] = [
  ...
  {
    categories: ['AI/ML Engineering', 'Data Engineering'],
    result: 'ML Platform Engineering',
  },
  {
    categories: ['DevOps & Cloud', 'Backend Development'],
    result: 'Platform Engineering',
  },
  {
    categories: ['UI/UX Design', 'Frontend Development'],
    result: 'Design Engineering',
  },
  {
    categories: ['Cybersecurity', 'DevOps & Cloud'],
    result: 'Cloud Security Engineering',
  },
  {
    categories: ['AI/ML Engineering', 'Backend Development'],
    result: 'AI Backend Engineering',
  },
  {
    categories: ['Database Engineering', 'Backend Development'],
    result: 'Data Platform Engineering',
  },
  {
    categories: ['Graphic Design', 'UI/UX Design'],
    result: 'Product Design Lead',
  },
  {
    categories: ['Mobile Development', 'UI/UX Design'],
    result: 'Mobile Design Lead',
  },
  {
    categories: ['Embedded Systems', 'DevOps & Cloud'],
    result: 'IoT Platform Engineering',
  },
];
...
export const careerPaths: Record<string, CareerPathDef[]> = {
  'Frontend Development': [
    {
      ...
      whyItFits:
        'Your frontend framework expertise qualifies you for development roles',
      relevantJobTitles: [
        'Frontend Developer',
        'Frontend Engineer',
        'UI Developer',
    ...
    },
    {
      ...
      description:
        'Build end-to-end applications combining frontend and backend skills',
      keyResponsibilities: [
        'Frontend development',
      ...
      whyItFits:
        'Adding backend skills to your frontend expertise opens full-stack opportunities',
      relevantJobTitles: [
    ...
    },
    {
      ...
      whyItFits:
        'Your broad frontend knowledge positions you for architecture roles',
      relevantJobTitles: [
        'Frontend Architect',
  ...
  'Backend Development': [
    ...
    },
    {
      ...
      whyItFits:
        'Learning frontend technologies would make you a versatile full-stack developer',
      relevantJobTitles: [
        'Full-Stack Developer',
        'Software Engineer',
        'Web Developer',
  ...
  'Full-Stack Development': [
    {
      ...
      whyItFits:
        'Your combined frontend and backend skills make you a versatile full-stack developer',
      relevantJobTitles: [
        'Full-Stack Developer',
        'MERN Stack Developer',
        'JavaScript Full-Stack Engineer',
    ...
    },
    {
      ...
      whyItFits:
        'Your broad skill set aligns well with general software engineering roles',
      relevantJobTitles: [
        'Software Engineer',
    ...
    },
    {
      ...
      whyItFits:
        'Your comprehensive knowledge prepares you for technical leadership',
      relevantJobTitles: [
        'Technical Lead',
        'Team Lead',
        'Engineering Lead',
  ...
  'UI/UX Design': [
    {
      ...
      description:
        'Lead design initiatives and create exceptional user experiences',
      keyResponsibilities: [
        'User research',
    ...
    },
    {
      ...
      whyItFits:
        'Learning frontend development would make you a powerful design engineer',
      relevantJobTitles: [
        'Design Engineer',
        'Design Technologist',
        'Creative Developer',
  ...
  'AI/ML Engineering': [
    {
      ...
      whyItFits:
        'Your strong foundation in ML frameworks and Python is perfect for this role',
      relevantJobTitles: [
        'ML Engineer',
        'AI Engineer',
    ...
    },
    {
      ...
      whyItFits:
        'Combining backend skills with AI expertise creates a specialized niche',
      relevantJobTitles: [
        'AI Backend Engineer',
    ...
    },
    {
      ...
      whyItFits:
        'Your data science and ML skills align well with data science roles',
      relevantJobTitles: [
        'Data Scientist',
        'Lead Data Scientist',
  ...
  'Graphic Design': [
    {
      ...
      whyItFits:
        'Your Adobe Creative Suite skills are ideal for graphic design',
      relevantJobTitles: [
        'Graphic Designer',
        'Visual Designer',
        'Brand Designer',
    ...
    },
    {
      ...
      whyItFits:
        'Your visual design skills are a strong foundation for UI/UX work',
      relevantJobTitles: [
        'UI Designer',
        'Visual UI Designer',
        'Digital Designer',
  ...
  'DevOps & Cloud': [
    ...
    },
    {
      ...
      whyItFits:
        'Adding security expertise to your cloud skills creates a valuable specialization',
      relevantJobTitles: [
  ...
  'Mobile Development': [
    {
      ...
      whyItFits:
        'Your mobile development skills qualify you for development roles',
      relevantJobTitles: [
        'Mobile Developer',
        'iOS Developer',
        'Android Developer',
    ...
    },
    {
      ...
      whyItFits:
        'Backend skills would complement your mobile expertise for end-to-end development',
      relevantJobTitles: [
  ...
  Cybersecurity: [
    ...
    },
    {
      ...
      whyItFits:
        'Adding DevOps skills to your security expertise creates a high-demand role',
  ...
  'Database Engineering': [
    ...
    },
    {
      ...
      whyItFits:
        'Backend development skills would enhance your data platform capabilities',
      relevantJobTitles: [
    ...
    },
    {
      ...
      whyItFits:
        'Your database expertise is a strong foundation for backend development',
      relevantJobTitles: [
        'Backend Developer',
        'Database Developer',
        'API Developer',
  ...
  'Data Engineering': [
    ...
    },
    {
      ...
      whyItFits:
        'Adding ML knowledge to your data engineering creates a specialized niche',
      relevantJobTitles: [
        'ML Platform Engineer',
        'MLOps Engineer',
        'AI Infrastructure Engineer',
    ...
    },
    {
      ...
      whyItFits:
        'Your data expertise positions you for architecture leadership',
      relevantJobTitles: [
        'Data Architect',
  ...
  'Embedded Systems': [
    {
      ...
      whyItFits:
        'Your embedded skills qualify you for specialized hardware roles',
      relevantJobTitles: [
        'Embedded Engineer',
        'Firmware Developer',
        'IoT Developer',
...
export const learningApproaches: Record<
  string,
  { title: string; steps: { action: string; description: string }[] }[]
> = {
  'Frontend Development': [
    {
      ...
      steps: [
        {
          ...
          description:
            'Create 3 complex applications using React/Vue with state management',
        },
        {
          action: 'Learn TypeScript',
          description:
            'Add type safety to your JavaScript projects systematically',
        },
        {
          action: 'Performance Optimization',
          description:
            'Study Core Web Vitals, lazy loading, and code splitting',
        },
        {
          action: 'Testing Expertise',
          description: 'Master Jest, Cypress, and React Testing Library',
        },
      ],
    },
    {
      ...
      steps: [
        {
          action: 'Learn Node.js',
          description: 'Build REST APIs with Express or NestJS',
        },
        {
          action: 'Database Basics',
          description: 'Understand SQL with PostgreSQL or MySQL',
        },
        {
        ...
        },
        {
          ...
          description: 'Use Docker, AWS, or Vercel for production deployment',
        },
      ],
    },
    {
      ...
      steps: [
        {
          action: 'Open Source',
          description: 'Contribute to React, Vue, or component libraries',
        },
        {
          action: 'Technical Writing',
          description: 'Blog about frontend patterns and solutions',
        },
        {
          action: 'Mentorship',
          description: 'Join communities like Discord, Reddit r/webdev',
        },
        {
          action: 'Portfolio',
          description: 'Showcase 5+ projects with live demos and source code',
        },
      ],
    },
  ],
  'Backend Development': [
    {
      ...
      steps: [
        {
          action: 'Master Databases',
          description:
            'Deep dive into PostgreSQL, indexing, and query optimization',
        },
        {
          action: 'API Design',
          description: 'Learn REST best practices and GraphQL fundamentals',
        },
        {
          action: 'Authentication',
          description:
            'Implement OAuth 2.0, JWT, and role-based access control',
        },
        {
          action: 'Testing',
          description:
            'Unit tests, integration tests, and load testing with JMeter',
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          description: 'Containerize applications and orchestrate deployments',
        },
        {
          action: 'CI/CD Pipelines',
          description:
            'Set up GitHub Actions or GitLab CI for automated testing',
        },
        {
          action: 'Cloud Services',
          description: 'Deploy on AWS (EC2, Lambda) or Google Cloud Platform',
        },
        {
          action: 'Monitoring',
          description:
            'Implement logging with ELK stack and monitoring with Prometheus',
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          description:
            'Study distributed systems, microservices, and caching strategies',
        },
        {
          action: 'Security',
          description:
            'Learn OWASP top 10, encryption, and security best practices',
        },
        {
          action: 'Code Reviews',
        ...
        {
          action: 'Mentoring',
          description: 'Help junior developers grow through pair programming',
        },
      ],
    },
  ],
      ...
      steps: [
        {
          action: 'Master Figma',
          description:
            'Learn auto-layout, components, and advanced prototyping',
        },
        {
          action: 'Design Systems',
          description: 'Create a complete component library with documentation',
        },
        {
          action: 'User Research',
          description: 'Conduct interviews, usability tests, and analyze data',
        },
        {
          action: 'Accessibility',
          description: 'Study WCAG guidelines and implement inclusive design',
        },
      ],
    },
    {
      ...
      steps: [
        {
          action: 'Learn HTML/CSS',
          description: 'Understand how designs translate to code',
        },
        {
          action: 'Basic JavaScript',
          description:
            'Add interactivity knowledge to communicate with developers',
        },
        {
          action: 'Design Handoff',
          description: 'Master tools like Zeplin and proper documentation',
        },
        {
          action: 'Version Control',
          description: 'Learn Git basics for design file management',
        },
      ],
    },
    {
      ...
      steps: [
        {
          action: 'Portfolio',
          description: 'Curate 4-6 case studies with process and outcomes',
        },
        {
          action: 'Networking',
          description:
            'Join design communities like Dribbble, Behance, ADPList',
        },
        {
          action: 'Side Projects',
          description: 'Redesign existing apps or create concept projects',
        },
        {
          action: 'Feedback',
          description: 'Participate in design critiques and iterate on work',
        },
      ],
    },
  ],
  'AI/ML Engineering': [
    {
      ...
      steps: [
        {
          action: 'Mathematics',
          description: 'Strengthen linear algebra, calculus, and statistics',
        },
        {
          action: 'Deep Learning',
          description: 'Complete fast.ai or deep learning specialization',
        },
        {
          action: 'Frameworks',
          description: 'Master PyTorch and TensorFlow with real datasets',
        },
        {
          action: 'MLOps',
          description: 'Learn model versioning, deployment, and monitoring',
        },
      ],
    },
    {
      ...
      steps: [
        {
          action: 'NLP or CV',
          description: 'Choose NLP (transformers) or Computer Vision (CNNs)',
        },
        {
          action: 'Cloud ML',
          description: 'Use AWS SageMaker, Google AI Platform, or Azure ML',
        },
        {
          action: 'Big Data',
          description: 'Learn Spark, Hadoop for large-scale data processing',
        },
        {
          action: 'Optimization',
          description:
            'Study model compression, quantization, and edge deployment',
        },
      ],
    },
    {
      ...
      steps: [
        {
          action: 'Kaggle Competitions',
          description: 'Participate in competitions and share solutions',
        },
        {
          action: 'Research Papers',
          description: 'Read and implement papers from arXiv',
        },
        {
          action: 'Open Source',
          description: 'Contribute to Hugging Face, scikit-learn, or PyTorch',
        },
        {
          action: 'Production Systems',
          description: 'Build end-to-end ML applications with APIs',
        },
      ],
    },
  ],
  'DevOps & Cloud': [
    {
      ...
      steps: [
        {
          action: 'Linux Administration',
          description:
            'Master shell scripting, process management, and networking',
        },
        {
          action: 'Docker Deep Dive',
          description: 'Multi-stage builds, networking, and compose files',
        },
        {
          action: 'Kubernetes',
          description: 'Pods, services, deployments, and Helm charts',
        },
        {
          action: 'Infrastructure as Code',
          description: 'Terraform and Ansible for automated provisioning',
        },
      ],
    },
    {
      ...
      steps: [
        {
          action: 'AWS Certification',
          description:
            'Prepare for Solutions Architect or DevOps Engineer cert',
        },
        {
          action: 'Multi-Cloud',
          description: 'Understand GCP and Azure equivalents',
        },
        {
          action: 'Serverless',
          description:
            'Lambda functions, API Gateway, and event-driven architecture',
        },
        {
          action: 'Cost Optimization',
          description: 'Right-sizing, reserved instances, and budget alerts',
        },
      ],
    },
    {
      ...
      steps: [
        ...
        {
          action: 'Monitoring',
          description: 'Prometheus, Grafana, ELK stack for observability',
        },
        {
          action: 'Incident Response',
          description: 'PagerDuty, runbooks, and post-mortem practices',
        },
        {
          action: 'Chaos Engineering',
          description: 'Test resilience with Chaos Monkey or Gremlin',
        },
      ],
    },
  ],
  'Full-Stack Development': [
    {
      ...
      steps: [
        {
          action: 'Integrate Technologies',
          description:
            'Build projects that connect React/Vue with Node.js APIs',
        },
        {
    ...
    },
    {
      ...
      steps: [
        {
          action: 'Full Projects',
          description: 'Create complete apps from database to UI',
        },
        {
          action: 'Deployment',
          description: 'Deploy both frontend and backend to production',
        },
        {
          action: 'Testing',
          description: 'Write unit and integration tests for all layers',
        },
        {
          action: 'Performance',
    ...
    steps: [
      {
        ...
        description: 'Master core concepts in your primary technology stack',
      },
      {
        action: 'Practice Daily',
        description: 'Code or design every day, even if just for 30 minutes',
      },
      {
        action: 'Build Projects',
        description: 'Create portfolio projects that solve real problems',
      },
      {
        action: 'Read Documentation',
        description: 'Study official docs to understand tools deeply',
      },
    ],
  },
  {
    ...
    steps: [
      {
        action: 'Related Technologies',
        description: 'Learn complementary skills to your main stack',
      },
      {
        action: 'Best Practices',
        description: 'Study design patterns, clean code, and architecture',
      },
      {
        action: 'Testing',
        description: 'Make testing a habit in all your projects',
      },
      {
        action: 'Deployment',
        description: 'Learn how to ship and maintain production applications',
      },
    ],
  },
  {
    ...
    steps: [
      {
        action: 'Open Source',
        description: 'Contribute to projects you use and admire',
      },
      {
        action: 'Networking',
        description: 'Attend meetups, conferences, and join online communities',
      },
      {
        action: 'Mentorship',
        description: 'Find a mentor and mentor others when possible',
      },
      {
        action: 'Stay Updated',
        description: 'Follow industry blogs, newsletters, and podcasts',
      },
    ],
  },
];
